...
const JoinSummaryScreen = (props: any) => {
  // Variables
  ...
  return (
    <KeyboardAvoidingView
      ...
      <View
        ...
        <Text style={styles.loginText2}>Facture garantie</Text>
        <View
          style={{
            width: '90%',
            justifyContent: 'space-between',
      ...
      <Button
        onPress={() => {
          navigation.navigate('JoinSuccessScreen');
        }}
        buttonText={'Payer'}
...
export default JoinSummaryScreen;
