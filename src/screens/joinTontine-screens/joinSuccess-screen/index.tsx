...
const JoinSuccessScreen = (props: any) => {
  // Variables
    ...
    <SafeAreaView style={styles.container}>
      <ImageBackground
        ...
        <View style={styles.topView}>
          ...
          <Text style={[styles.heading, {fontSize: fontSizes.f21}]}>
            Félicitation tu as rejoins une tontine
          </Text>
        </View>
...
export default JoinSuccessScreen;
