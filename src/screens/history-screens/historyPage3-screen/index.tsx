...
const HistoryPage3Screen = (props: any) => {
  // Variables
    ...
    <KeyboardAvoidingView
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => setTab('Mon équipe')}
            style={{
              height: 40 * heightRef,
              width: '30%',
              backgroundColor:
                tab == 'Mon équipe' ? colors.primary : 'transparent',
              borderRadius: 10 * heightRef,
              justifyContent: 'center',
              alignItems: 'center',
            }}>
            <Text
              style={{
                color: tab == 'Mon équipe' ? colors.background : '#6B7280',
                fontWeight: fontWeights.h700,
                fontSize: 12 * heightRef,
              }}>
              Mon équipe
...
export default HistoryPage3Screen;
