...
const ManageNameTontineScreen = (props: any) => {
  // Variables
      ...
      <View
        ...
        <View style={{top: -40 * heightRef, width: '76%', alignSelf: 'center'}}>
          <Text style={styles.loginText2}>
            Tu es la personne responsable de ta communauté.
          </Text>
          <Text style={styles.loginText2}>Bravo!!!</Text>
          <Text style={styles.loginText2}>Donne un nom à ta tontine.</Text>
          <ImageBackground
        ...
        <Button
          onPress={() => {
            navigation.navigate('ManageChoiceScreen');
          }}
...
export default ManageNameTontineScreen;
